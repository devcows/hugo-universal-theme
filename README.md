...
ms_tile_color sets the background color if site is bookmarked to Windows 7/8/10 start tiles.

Windows recommend that you use one of the standardised Windows colors
* Teal 008299
* Blue 2672EC
* Purple 8C0095
* Dark Purple 5133AB
...
Certain versions of Safari use monochrome versions of favicons, with a background color.
...
description: >
  <ul class="list-style-none">
    <li>7 preprepared color variations.</li>
