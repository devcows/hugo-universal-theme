...
The following [HTML metadata](https://www.w3schools.com/tags/tag_meta.asp) is set by default for every page but can also be customized by setting the respective [Hugo front matter variables](https://gohugo.io/content-management/front-matter/#front-matter-variables):
