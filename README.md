...
Set in `Config.toml` under `[params.favicons]`

We've used those generated by www.realfavicongenerator.net 

If disable will fall-back to the `favicon.ico` at the root of the site

ms_tile_colour sets the background colour if site is bookmarked to Windows 7/8/10 start tiles.

Windows recommend that you use one of the standardised Windows colours
* Teal 008299
* Blue 2672EC
* Purple 8C0095
* Dark Purple 5133AB
...
Certain versions of Safari use monochrome versions of favicons, with a background colour.

safari_colour sets this background colour.
