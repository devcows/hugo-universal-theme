          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
            ...
            >
              ...
              <p className="mt-6 text-lg leading-8 text-zinc-400">
                Des solutions innovantes pour transformer votre entreprise et accélérer votre croissance
              </p>
            </motion.div>
          </div>
                ...
                >
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-lg font-semibold text-white">Ce que nous offrons:</h3>
                      <ul className="space-y-3">
                        {service.features.map((feature) => (
                          <li key={feature} className="flex items-start">
                            ...
                            <span className="ml-3 text-zinc-400">{feature}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
